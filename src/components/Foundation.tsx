...
const MOCK_DATA = [
  ...
  {
    id: 2,
    title: "RAGI JI FOUNDATION – Another Initiative",
    paragraphs: [
      "RAGI JI FOUNDATION's programs also focus on vocational training for youth, ensuring that they gain skills to find sustainable employment.",
